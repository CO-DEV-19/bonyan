...
function spa_and_salon_customizer_theme_info( $wp_customize ) {
    ...
    $theme_info .= '<span class="sticky_info_row"><label class="row-element">' . __( 'View demo', 'medical-spa' ) . ': </label><a href="' . esc_url( 'https://demo.rarathemes.com/medical-spa/' ) . '" target="_blank">' . __( 'here', 'medical-spa' ) . '</a></span><br />';
