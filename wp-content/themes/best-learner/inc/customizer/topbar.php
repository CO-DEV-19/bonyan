...
$wp_customize->add_panel( 'header_top_panel', array(
    'title'          => __( 'Header Top', 'best-learner' ),
    'priority'       => 20,
...
$wp_customize->add_section(
    ...
    array(
        'title'    => __( 'Contact Info', 'best-learner' ),
...
$wp_customize->add_control(
    'theme_options[show_header_contact_info]',
    array(
        'label'       => __( 'Show Contact Info', 'best-learner' ),
...
$wp_customize->add_control(
    ...
    array(
        'label'           => __( 'Location', 'best-learner' ),
        'description'     => __( 'Enter Location.', 'best-learner' ),
        'section'         => 'header_contact_info_section',
        'active_callback' => 'best_learner_contact_info_ac',
    )
);
...
$wp_customize->add_control(
    ...
    array(
        'label'           => __( 'Phone', 'best-learner' ),
        'description'     => __( 'Enter phone number.', 'best-learner' ),
        'section'         => 'header_contact_info_section',
        'active_callback' => 'best_learner_contact_info_ac',
    )
);
...
$wp_customize->add_control(
    'theme_options[header_email]',
    array(
        'label'           => __( 'Email', 'best-learner' ),
        'description'     => __( 'Enter valid email address.', 'best-learner' ),
        'section'         => 'header_contact_info_section',
        'active_callback' => 'best_learner_contact_info_ac',
    )
);
...
$wp_customize->add_section(
    ...
    array(
        'title'    => __( 'Social Links', 'best-learner' ),
        'panel'    => 'header_top_panel',
        'priority' => 20,
    )
);
...
$wp_customize->add_control(
    'theme_options[show_header_social_links]',
    array(
        'label'       => __( 'Show Social Links', 'best-learner' ),
...
$wp_customize->add_control(
    'theme_options[social_link_1]',
    array(
        'label'           => __( 'Social Link 1', 'best-learner' ),
        'description'     => __( 'Enter valid url.', 'best-learner' ),
        'section'         => 'header_social_links_section',
        'type'            => 'url',
        'active_callback' => 'best_learner_social_links_active',
    )
);
...
$wp_customize->add_control(
    'theme_options[social_link_2]',
    array(
        'label'           => __( 'Social Link 2', 'best-learner' ),
        'description'     => __( 'Enter valid url.', 'best-learner' ),
        'section'         => 'header_social_links_section',
        'type'            => 'url',
        'active_callback' => 'best_learner_social_links_active',
...
$wp_customize->add_control(
    'theme_options[social_link_3]',
    array(
        'label'           => __( 'Social Link 3', 'best-learner' ),
        'description'     => __( 'Enter valid url.', 'best-learner' ),
        'section'         => 'header_social_links_section',
        'type'            => 'url',
        'active_callback' => 'best_learner_social_links_active',
