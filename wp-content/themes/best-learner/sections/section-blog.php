...
?>
<?php 
	 $blog_title    = best_learner_get_option( 'blog_title' );
	 $blog_category = best_learner_get_option( 'blog_category' );
	 $blog_number	= best_learner_get_option( 'blog_number' );
		    	...
		    	<div class="post-item">
			      	<?php if(has_post_thumbnail()):?>
				        <div class="featured-image">
				        	<a href="<?php the_permalink();?>"><?php the_post_thumbnail('best-learner-blog');?></a>  
				        </div>
			    	<?php endif?>
