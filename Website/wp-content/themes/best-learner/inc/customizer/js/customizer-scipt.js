...
*/
 jQuery(document).ready(function($) {
    $('#best-learner-img-container li label img').click(function(){    	
        $('#best-learner-img-container li').each(function(){
            $(this).find('img').removeClass ('best-learner-radio-img-selected') ;
        });
        $(this).addClass ('best-learner-radio-img-selected') ;
    });                    
});
