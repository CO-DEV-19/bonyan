...
function best_learner_additional_info_active( $control ) {
...
function best_learner_additional_info_page( $control ) {
    $content_type = $control->manager->get_setting( 'theme_options[ad_content_type]' )->value();
    return ( best_learner_additional_info_active( $control ) && ( 'ad_page' == $content_type ) );
}

function best_learner_featured_plans_active( $control ) {
...
function best_learner_featured_plans_page( $control ) {
    $content_type = $control->manager->get_setting( 'theme_options[cs_content_type]' )->value();
    return ( best_learner_featured_plans_active( $control ) && ( 'cs_page' == $content_type ) );
}

function best_learner_featured_courses_active( $control ) {
...
function best_learner_featured_courses_page( $control ) {
    $content_type = $control->manager->get_setting( 'theme_options[ss_content_type]' )->value();
    return ( best_learner_featured_courses_active( $control ) && ( 'ss_page' == $content_type ) );
}

function best_learner_slider_active( $control ) {
...
function best_learner_slider_page( $control ) {
    $content_type = $control->manager->get_setting( 'theme_options[sr_content_type]' )->value();
    return ( best_learner_slider_active( $control ) && ( 'sr_page' == $content_type ) );
}

function best_learner_cta_active( $control ) {
...
function best_learner_blog_active( $control ) {
 ...
 */
function best_learner_contact_info_ac( $control ) {
...
function best_learner_social_links_active( $control ) {
